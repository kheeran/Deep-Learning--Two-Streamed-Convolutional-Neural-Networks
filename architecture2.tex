...
{\includegraphics[width=8cm,height=8cm]{images/LMC.png}};

% conv1_1,conv1_2
\pic[shift={(0,0,0)}] at (0,0,0) {RightBandedBox={name=cr1,caption=conv1,%
        xlabel={{"32","32"}},ylabel=41,zlabel=85,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=40,width={7},depth=40}};
%pool1
...
\pic[shift={(2,0,0)}] at (p2-east) {RightBandedBox={name=cr3,caption=conv3,%
        xlabel={{"64","64","64"}},ylabel=41,zlabel=43,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=20,width={14},depth=20}};
%pool3
...
\pic[shift={(3,0,0)}] at (p5-east) {RightBandedBox={name=fc6,caption=fc6,%
        xlabel={{"1",""}},zlabel=1024,fill=\FcColor,bandfill=\FcReluColor,%
...
%%%%%%%%%%
% fc8
\pic[shift={(1.5,0,0)}] at (fc6-east) {RightBandedBox={name=fc7,caption=fc7+softmax,%
...
\draw [connection]  (fc7-east)       -- node {\midarrow} (fc7-west);
